		...
		<div id="layoutSidenav_content">
			<div class="container mt-2 px-3">
				...
				<ol class="breadcrumb mb-4">
					...
					<li class="breadcrumb-item active">EditCinemaForm</li>
				</ol>

				<form:form
					action="${pageContext.request.contextPath}/cinema/editCinema"
					...
					<div class="row">
						...
						<div class="col mb-3">
							...
							<form:select class="form-select" path="stateId" id="state">
								...
								<form:options selected="${cinemaObj.stateId == id ? 'selected' : '' }" items="${stateList}" itemValue="id"
									itemLabel="name" />
							</form:select>
									...
									<label>
										<div class="showtime-container">
											<form:checkbox path="selectedShowtimeList"
												...
												checked="${cinemaObj.selectedShowtimeList.contains(showtime.id) ? 'checked' : ''}"/>
